...
### 📸 獨特回報機制
- 站一～站三：拍攝一張符合元素主題的照片
- 站四（終點）：拍攝最後一張照片 + 寫下一句話總結
- 路上收起手機，專注騎行體驗

### 🎨 視覺設計風格
- JRPG 任務風格介面：仿遊戲任務簡報的指引卡片
- 元素配色系統：
  - 風×海：藍色系 (#4A90D9)
  - 火：橙色系 (#E87D3E)
  - 土×木：大地色系 (#B8955A)
...
### 🎨 專屬紀念成果
- **三種紀念卡片版型**：明信片（10:7）、拍立得（1:1）、IG 限時動態（9:16）
- **明信片版型**：左側 2×2 照片拼貼（懷舊濾鏡），右側元素徽章、路線資訊、116km 完騎認證
- **拍立得版型**：四宮格方形拼貼，雙金色邊框與角標裝飾，手寫風格金句
- **IG 限時動態版型**：9:16 直式，安全區域設計，大標 116km，路線時間軸，2×2 照片網格
- 可下載分享至社群

### 🎭 風之使者劇情系統
- 開場動畫：數位信封交付儀式感
- 站點確認機制：防止提早破梗，需抵達才能解鎖
- 終點大反轉：信封打開的驚喜時刻
...
| **Canvas 生成** | HTML5 Canvas API | 紀念卡片動態生成 |
